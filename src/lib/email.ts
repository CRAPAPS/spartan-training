...
export async function sendEnrollmentConfirmation(
  ...
  const trackLabel =
    track === 'private-investigation' ? 'Private Detective (72hr)'
      ...
      <table width="580" cellpadding="0" cellspacing="0" style="background:#111009;border:1px solid #2A2520;border-radius:4px;">
        ...
        <tr>
          <td style="padding:32px 40px;">
            ...
            <p style="color:#B8B0A0;font-size:14px;line-height:1.6;">Your enrollment in the MJM 2026 <strong style="color:#C5A059;">${trackLabel}</strong> program has been confirmed. A magic link to access your dashboard will arrive in a separate email.</p>
